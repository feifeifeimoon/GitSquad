...
// Custom status icons — a single 14×14 viewBox "progress ring" family where
// each state's fill communicates completion at a glance:
//   backlog = dotted ring, todo = empty ring, in_progress = half pie,
//   in_review = 3/4 pie, done = full + check, blocked = slash, cancelled = ✕.
